        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane active" id="sour">
                ...
                <%--<div class="row tableHeader">
                    ...
                    <div class="col-lg-12 col-md-1 col-sm-1 col-xs-1 ">增加员工信息</div>


                </div>--%>
                <div class=" tablebody row">
                    <form class="form-horizontal addEmp" action="${pageContext.request.contextPath}/emp/addEmp" method="post">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <lavel class="radio-inline">
                                    <input type="radio" name="sex" value="男" checked style="margin-top: 15px">男
                                </lavel>
                                <lavel class="radio-inline">
                                    <input type="radio" name="sex" value="女" style="margin-top: 15px">女
                                </lavel>
                            ...
                            <div class="col-sm-6">
                                <select name="dept_id" class="form-control">
                                    <c:forEach items="${empList}" var="emp">
                                        <c:if test="${fn:contains(empList,emp.dept.dname)}">
                                        <option value="${emp.dept.dept_id}">${emp.dept.dname}</option>
                                        </c:if>
                                    </c:forEach>
                                </select>
                                <%--<select  class="form-control"  name="dept_id">
                                    <c:forEach items="${deptList}" var="dept">
                                        <c:if test="${fn:contains(deptList,dept.dname)}">
