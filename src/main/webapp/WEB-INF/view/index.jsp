...
--%>
        ...
        <div class="meun-item" onclick="location.href ='${pageContext.request.contextPath}/dept/countempdeptView'" role="tab" data-toggle="tab"><img src="${pageContext.request.contextPath}/static/images/icon_user_grey.png">部门人数</div>
        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane active" id="sour">
                ...
                <div class="row tablebody">
                    <div class="backgroundtimg">
                        <img src="${pageContext.request.contextPath}/static/images/timg.jpg" alt="" width="100%" height="100%">
                    </div>
                </div>
